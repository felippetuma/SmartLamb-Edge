...
O SmartLamp é uma solução baseada em Internet das Coisas (IoT) desenvolvida para demonstrar a comunicação entre um dispositivo físico e uma infraestrutura de software hospedada em nuvem.
...
O SmartLamp possui uma arquitetura baseada na integração entre hardware, API e infraestrutura em nuvem.
